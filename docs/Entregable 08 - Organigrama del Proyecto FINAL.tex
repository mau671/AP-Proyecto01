...
% Títulos
\titleformat{\section}
  {\normalfont\Large\bfseries\color{tecblue}}
  {\thesection}{1em}{}
\titleformat{\subsection}
  {\normalfont\large\bfseries\color{tecblue}}
  {\thesubsection}{1em}{}
\titleformat{\subsubsection}
  {\normalfont\normalsize\bfseries\color{tecblue}}
  {\thesubsubsection}{1em}{}
...
\begin{titlepage}
    ...
    {\Large\bfseries Entregable 08 - Organigrama del proyecto\par}
    \vspace{0.7cm}
    {\large Plataforma Universitaria Integrada:\par}
    \vspace{0.15cm}
    {\large Modernización y Centralización de Procesos Académicos y Administrativos\par}
