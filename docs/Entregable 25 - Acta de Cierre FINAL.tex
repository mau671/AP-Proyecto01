...
\textbf{Presupuesto asignado} & ₡27,200,500 \\
\bottomrule
\end{tabularx}
\end{table}
...
\caption{Estado de los entregables del proyecto}\label{tab:estado-entregables}\\
\toprule
...
\midrule
\textbf{Total general} & \textbf{₡27,200,500} & \textbf{₡17,625,200} & \textbf{₡17,625,200} \\
\bottomrule
\end{tabularx}
\end{table}
