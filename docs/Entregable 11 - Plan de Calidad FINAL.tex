...
La calidad guarda igualmente una estrecha relación con el presupuesto del proyecto. En el caso de negocio se definió un presupuesto total estimado de ₡27,200,500. Dentro de dicho monto se contempla una partida específica de pruebas y control de calidad por ₡3,000,000. Adicionalmente, diversas labores de calidad se encuentran distribuidas dentro del esfuerzo de documentación, desarrollo, gestión y verificación técnica.
