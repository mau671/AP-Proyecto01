...
\subsection{Información general del documento}
...
\textbf{Documento} & Cronograma del Proyecto \\
...
\subsection{Propósito del cronograma}
...
\subsection{Verificación de cumplimiento del Entregable 6}
...
De esta manera, esta sección explica la estructura y los componentes del Entregable 6, mientras que el archivo \texttt{cronograma.pdf} funciona como evidencia visual directa del cronograma generado desde la herramienta.
...
\subsection{Evidencias del entregable}
...
\subsection{Conclusión del Entregable 6}
...
\subsubsection*{Inicio y planificación base}
...
\begin{center}
\textit{Tabla 6.1. Vista tabular del Diagrama de Gantt: inicio y planificación base.}
\end{center}
\end{widepage}

\begin{widepage}
\subsubsection*{Tabla del Diagrama de Gantt: planificación complementaria}
...
\begin{center}
\textit{Tabla 6.2. Vista tabular del Diagrama de Gantt: planificación complementaria.}
\end{center}
\end{widepage}

\begin{widepage}
\subsubsection*{Tabla del Diagrama de Gantt: ejecución del prototipo}
...
\begin{center}
\textit{Tabla 6.3. Vista tabular del Diagrama de Gantt: ejecución del prototipo.}
\end{center}
\end{widepage}

\begin{widepage}
\subsubsection*{Tabla del Diagrama de Gantt: supervisión, cierre y rubros adicionales}
...
\begin{center}
\textit{Tabla 6.4. Vista tabular del Diagrama de Gantt: supervisión, cierre y rubros adicionales.}
\end{center}
\end{widepage}
...
\subsubsection*{Hoja de recursos utilizada en Microsoft Project}
...
\begin{center}
\textit{Tabla 6.5. Hoja de recursos utilizada en Microsoft Project.}
\end{center}
\end{widepage}
