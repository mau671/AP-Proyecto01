...
\begin{tabularx}{\textwidth}{Y Y Y}
\toprule
\textbf{Aprobado por} & \textbf{Aprobado por} & \textbf{Aprobado por} \\
\midrule
& & \\
& & \\
Lic. Patricia Vargas Soto & Tamara Robles Camacho & Mauricio González Prendas \\
Directora Administrativa & Project Manager & Desarrollador Frontend 1 y QA \\
\midrule
& & \\
& & \\
Carlos Sainz Arce & Isaac Jiménez Blanco & Jorge Abarca Quiros \\
Desarrollador Frontend 2 y QA & Analista de Negocio y Documentador 1 & Analista de Negocio y Documentador 2 \\
\midrule
& & \\
& & \\
Dr. Roberto Mora Fallas & & \\
