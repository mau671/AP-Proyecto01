...
\midrule
Mano de obra (equipo de proyecto) & ₡14,000,000 millones & 51\% \\
Licencias y herramientas de software & ₡1,700,000 millones & 6\% \\
Infraestructura y hosting & ₡1,900,000 millones & 7\% \\
Capacitación y gestión del cambio & ₡2,300,500 millones & 9\% \\
Pruebas y control de calidad & ₡3,000,000 millones & 11\% \\
Contingencias (10\%) & ₡1,600,000 millones & 6\% \\
Documentación y gestión del proyecto & ₡2,700,000 millones & 10\% \\
TOTAL ESTIMADO & ₡27,200,500 millones & 100\% \\
\bottomrule
\end{tabularx}
\end{table}
...
\toprule
Inversión total del proyecto & ₡27,200,500 millones \\
Beneficio anual estimado & ₡27,000,000 millones \\
Período de recuperación de la inversión & $\approx$ 12 meses \\
Retorno sobre la Inversión proyectado (año 1) & -0.7\% \\
Retorno sobre la Inversión proyectado (año 3) & \textgreater{}197\% \\
Relación Costo-Beneficio (B/C) & 0.99 (primer año) / \textgreater{}2.97 (año 3) \\
\bottomrule
\end{tabularx}
\end{table}
...
Los beneficios proyectados, tanto cuantitativos como cualitativos, justifican el costo de la inversión inicial, con un período de recuperación estimado cercano a los doce meses y un retorno sobre la inversión superior al 197\% en un horizonte de tres años. Además, la plataforma posicionará a la institución en un nivel de madurez tecnológica que le permitirá competir, crecer y ofrecer servicios de calidad a su comunidad universitaria.
