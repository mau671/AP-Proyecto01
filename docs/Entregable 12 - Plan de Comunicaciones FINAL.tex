...
\newcommand{\DocumentoTitulo}{Entregable 12 - Plan de Comunicaciones}
...
{\huge Plan de Comunicaciones \par}
...
\caption{Matriz de comunicaciones}\label{tab:matriz-comunicaciones}\\
\toprule
