...
\begin{itemize}
    ...
    \item Los documentos entregables se completan y revisan satisfactoriamente antes del 24 de junio de 2026
...
\subsection{Restricción temporal sumamente fuerte}

El proyecto tecnológico debe entregarse irrevocablemente el 24 de junio de 2026 por lo que el equipo ejecutor cuenta con un periodo temporal sumamente reducido para lograr completar toda la documentación el prototipo visual la revisión de calidad estricta y el cierre formal ya que este riesgo inminente puede afectar la profundidad esperada de algunos entregables si el grupo no prioriza correctamente el volumen de trabajo.
...
\begin{itemize}
    \item Mano de obra estipulada para el equipo principal del proyecto por 14000000 de colones exactos
    \item Adquisición de licencias comerciales y distintas herramientas de software por 1700000 colones
    \item Alquiler de infraestructura de servidores y hosting temporal por 1900000 colones
    \item Sesiones de capacitación requerida y gestión institucional del cambio por 2300500 colones
    \item Ejecución de pruebas sistémicas integrales y estricto control de calidad por 3000000 de colones
    \item Reservas financieras para enfrentar contingencias e imprevistos por 1600000 colones
    \item Esfuerzo en documentación y gestión administrativa constante del proyecto por 2700000 colones
    \item Total global estimado para la ejecución total ascendiendo a 27200500 colones exactos
\end{itemize}
