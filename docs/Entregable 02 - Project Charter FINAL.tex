...
% Contenido
% =========================
\section{Charter / contract}

\begin{table}[H]
\centering
\begin{tabularx}{0.82\textwidth}{p{3.8cm} Y}
\toprule
\textbf{Title} & Plataforma Universitaria Integrada \\
\textbf{Sponsor} & Dr. Roberto Mora Fallas \\
\textbf{Leader} & Tamara Robles Camacho \\
\textbf{Date} & 8 de junio de 2026 \\
\textbf{Version} & 1.0 \\
\bottomrule
\end{tabularx}
\end{table}
...
Isaac Jiménez Blanco Analista de Negocio y Documentador
...
Mauricio González Prendas Desarrollador Front-End y QA
...
El equipo núcleo del proyecto estará compuesto por tres personas, con roles combinados debido al tamaño del grupo.

\begin{itemize}[leftmargin=*]
    \item 1 Project Manager
    \item 1 Analista de Negocio y Documentador
    \item 1 Desarrollador Front-End
    \item 1 Responsable de QA, asumido por el desarrollador Front-End
...
Analista de Negocio y Documentador
...
Desarrollador Front-End y QA

Responsable de construir el prototipo web navegable y realizar pruebas básicas de calidad.
...
El presupuesto preliminar del proyecto es de ₡23,200,500 según el Business Case elaborado. La distribución referencial es la siguiente:

\begin{itemize}[leftmargin=*]
    \item Mano de obra del equipo de proyecto ₡10,000,000
    ...
    \item Total estimado ₡23,200,500
\end{itemize}
...
Isaac Jiménez Blanco - Member - Analista de Negocio y Documentador

Firma: \rule{7cm}{0.4pt}

Fecha: 8/06/2026

Mauricio González Prendas - Member - Desarrollador Front-End y QA
