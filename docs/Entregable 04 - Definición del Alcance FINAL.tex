...
La definición del alcance del proyecto establece una base clara para desarrollar el prototipo visual y los documentos requeridos debido a que el trabajo incluido permite representar los procesos principales mientras que lo excluido evita expectativas incorrectas sobre sistemas reales. Los supuestos y restricciones muestran que el proyecto debe ejecutarse en un periodo planificado de tres meses y con recursos controlados por lo tanto es necesario mantener control sobre las actividades y evitar adiciones innecesarias. Con esta delimitación el equipo cuenta con una referencia formal para elaborar el cronograma y los planes de calidad además de mantener la coherencia con los documentos previos para asegurar que el producto final responda a los objetivos originales del trabajo.
