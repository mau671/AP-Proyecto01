...
\caption{Matriz de trazabilidad}\label{tab:trazabilidad}\\[-0.5em]
\toprule
...
\caption{Resumen consolidado de casos, actividades o evidencias}\label{tab:casos-resumen}\\[-0.5em]
\toprule
...
\caption{Registro formal de hallazgos o defectos}\label{tab:defectos}\\[-0.5em]
\toprule
...
\caption{Evidencias visuales utilizadas}\label{tab:anexo-evidencias}\\[-0.5em]
\toprule
