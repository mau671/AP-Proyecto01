...
export function TeacherHome({ user }: { user: DemoUser }) {
  ...
  const totalStudents =
    taughtCourses[0]?.periods[0]?.courses.reduce(
      ...
      <section className="grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
        <div className="space-y-5">
          ...
          <div className="grid gap-3 rounded-xl border border-border p-4 md:grid-cols-3">
            ...
            <Stat label="Estudiantes activos" value={String(totalStudents)} />
          </div>
        </div>
        ...
        <aside className="rounded-xl border border-border p-4">
          ...
          <div className="space-y-1 text-sm text-muted-foreground">
            <p>
              <strong>Departamento:</strong> {teacherProfile.department}
            </p>
            <p>
              <strong>Correo electrónico:</strong> {teacherProfile.email}
            </p>
          </div>
        </aside>
      </section>
                          ...
                          <TableHeader>
                            <TableRow>
                              ...
                              <TableHead className="text-right">
                                ...
                                <UsersIcon className="inline size-4" />
                              </TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
